 ...
 * Required in .env: VITE_SUPABASE_URL, VITE_SUPABASE_ANON_KEY, SEED_EMAIL, SEED_PASSWORD
 */
...
if (!SUPABASE_URL || !SUPABASE_ANON_KEY || !SEED_EMAIL || !SEED_PASSWORD) {
  console.error('Missing env vars. Required: VITE_SUPABASE_URL, VITE_SUPABASE_ANON_KEY, SEED_EMAIL, SEED_PASSWORD');
  process.exit(1);
}
